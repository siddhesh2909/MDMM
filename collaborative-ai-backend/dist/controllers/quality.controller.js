...
exports.getQualityOverview = exports.getDatasetQuality = void 0;
 ...
 */
const getDatasetQuality = async (req, res) => {
    try {
        const user = req.user;
        if (!user)
        ...
        const snapshot = await prisma_1.default.qualitySnapshot.findFirst({
            where: { datasetId },
            orderBy: { recordedAt: 'desc' },
        });
        // Get quality history (last 10)
        const history = await prisma_1.default.qualitySnapshot.findMany({
            where: { datasetId },
            orderBy: { recordedAt: 'desc' },
            take: 10,
        });
...
exports.getDatasetQuality = getDatasetQuality;
const getQualityOverview = async (req, res) => {
    try {
        ...
        const filteredDatasets = datasets.filter(ds => (0, permission_1.canViewDataset)(ds, user));
...
exports.getQualityOverview = getQualityOverview;

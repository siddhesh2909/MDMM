...
async function cleanStaticData() {
    try {
        console.log("Removing auto-seeded tutorial contracts to ensure real data integration...");
        ...
        // Easiest is to just wipe all Data Contracts and Datasets to give a blank slate for testing!
